...
#define VALVE_OUTER_1_DATA_DIR_PIN DDC5
#define VALVE_OUTER_1_DATA PORTC
#define VALVE_OUTER_1_DATA_PIN PORTC5
#define VALVE_OUTER_1_DATA_REF C

#define VALVE_OUTER_2_DATA_DIR DDRC
#define VALVE_OUTER_2_DATA_DIR_PIN DDC4
#define VALVE_OUTER_2_DATA PORTC
#define VALVE_OUTER_2_DATA_PIN PORTC4
...
#define VALVE_OUTER_5_DATA_DIR DDRC
#define VALVE_OUTER_5_DATA_DIR_PIN DDC2
#define VALVE_OUTER_5_DATA PORTC
#define VALVE_OUTER_5_DATA_PIN PORTC2
#define VALVE_OUTER_5_DATA_REF C

#define VALVE_OUTER_6_DATA_DIR DDRD
#define VALVE_OUTER_6_DATA_DIR_PIN DDD4
#define VALVE_OUTER_6_DATA PORTD
#define VALVE_OUTER_6_DATA_PIN PORTD4
#define VALVE_OUTER_6_DATA_REF D
